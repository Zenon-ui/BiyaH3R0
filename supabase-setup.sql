...
-- Column added after the table already existed in earlier deployments —
-- "create table if not exists" above won't retrofit it, so this handles
-- upgrading an existing database. No-op on a fresh install.
