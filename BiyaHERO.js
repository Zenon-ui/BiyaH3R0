...
.forEach(btn => {
  ...
  const lagunaDestinations = [
    // ---- Cities & town centers ----
    { name: 'Santa Cruz Public Market', sub: 'Santa Cruz, Laguna (provincial capital) — 26 barangays', category: 'City Center',
    ...
    { name: 'Calamba City Hall', sub: 'Calamba City, Laguna — 54 barangays', category: 'City Center',
    ...
    { name: 'San Pablo City Plaza', sub: 'San Pablo City, Laguna — 80 barangays', category: 'City Center',
      latlng: { lat: 14.0703, lng: 121.3256 },
      hazards: [ { t:0.5, label:'Road bump · uneven pavement', color:'var(--status-yellow)' } ] },
    { name: 'Biñan City Hall', sub: 'Biñan City, Laguna — 24 barangays', category: 'City Center',
      latlng: { lat: 14.3426, lng: 121.0839 }, hazards: [] },
    { name: 'Cabuyao City Hall', sub: 'Cabuyao City, Laguna — 18 barangays', category: 'City Center',
      latlng: { lat: 14.2776, lng: 121.1250 }, hazards: [] },
    { name: 'Los Baños Municipal Hall', sub: 'Los Baños, Laguna — 14 barangays', category: 'City Center',
    ...
    { name: 'Santa Rosa City Hall', sub: 'Rizal Blvd, Santa Rosa City, Laguna — 18 barangays', category: 'City Center',
    ...
    { name: 'San Pedro City Hall', sub: 'San Pedro City, Laguna — 27 barangays', category: 'City Center',
    ...
    { name: 'Alaminos Municipal Hall', sub: 'Alaminos, Laguna — 15 barangays', category: 'City Center',
      latlng: { lat: 14.063469, lng: 121.245128 }, hazards: [] },
    { name: 'Bay Municipal Hall', sub: 'Bay, Laguna — old Laguna provincial capital — 15 barangays', category: 'City Center',
      latlng: { lat: 14.18, lng: 121.28 }, hazards: [] },
    { name: 'Calauan Municipal Hall', sub: 'Calauan, Laguna — 17 barangays', category: 'City Center',
      latlng: { lat: 14.15, lng: 121.32 }, hazards: [] },
    { name: 'Cavinti Municipal Hall', sub: 'Cavinti, Laguna — 19 barangays', category: 'City Center',
      latlng: { lat: 14.245128, lng: 121.507419 }, hazards: [] },
    { name: 'Famy Municipal Hall', sub: 'Famy, Laguna — 20 barangays', category: 'City Center',
      latlng: { lat: 14.43, lng: 121.45 }, hazards: [] },
    { name: 'Kalayaan Municipal Hall', sub: 'Kalayaan, Laguna — 3 barangays', category: 'City Center',
      latlng: { lat: 14.328, lng: 121.48 }, hazards: [] },
    { name: 'Liliw Municipal Hall', sub: 'Liliw, Laguna — "Flip-flops Capital of the Philippines" — 33 barangays', category: 'City Center',
      latlng: { lat: 14.13, lng: 121.436 }, hazards: [] },
    { name: 'Luisiana Municipal Hall', sub: 'Luisiana, Laguna — "Little Baguio of Laguna" — 23 barangays', category: 'City Center',
      latlng: { lat: 14.185, lng: 121.5109 }, hazards: [] },
    { name: 'Lumban Municipal Hall', sub: 'Lumban, Laguna — Embroidery Capital of the Philippines — 16 barangays', category: 'City Center',
      latlng: { lat: 14.297, lng: 121.459 }, hazards: [] },
    { name: 'Mabitac Municipal Hall', sub: 'Mabitac, Laguna — 15 barangays', category: 'City Center',
      latlng: { lat: 14.43, lng: 121.42 }, hazards: [] },
    { name: 'Magdalena Municipal Hall', sub: 'Magdalena, Laguna — Bamboo Capital of Laguna — 24 barangays', category: 'City Center',
      latlng: { lat: 14.198907, lng: 121.429145 }, hazards: [] },
    { name: 'Majayjay Municipal Hall', sub: 'Majayjay, Laguna — foot of Mt. Banahaw — 40 barangays', category: 'City Center',
      latlng: { lat: 14.1463, lng: 121.4729 }, hazards: [] },
    { name: 'Nagcarlan Municipal Hall', sub: 'Nagcarlan, Laguna — 52 barangays (most of any Laguna town)', category: 'City Center',
      latlng: { lat: 14.1364, lng: 121.4165 }, hazards: [] },
    { name: 'Paete Municipal Hall', sub: 'Paete, Laguna — 9 barangays', category: 'City Center',
      latlng: { lat: 14.364557, lng: 121.481638 }, hazards: [] },
    { name: 'Pagsanjan Municipal Hall', sub: 'Pagsanjan, Laguna — "Tourist Capital of Laguna" — 16 barangays', category: 'City Center',
      latlng: { lat: 14.273283, lng: 121.449060 }, hazards: [] },
    { name: 'Pakil Municipal Hall', sub: 'Pakil, Laguna — Pilgrimage Capital of Laguna — 13 barangays', category: 'City Center',
      latlng: { lat: 14.380826, lng: 121.478914 }, hazards: [] },
    { name: 'Pangil Municipal Hall', sub: 'Pangil, Laguna — 8 barangays', category: 'City Center',
      latlng: { lat: 14.4, lng: 121.47 }, hazards: [] },
    { name: 'Pila Municipal Hall', sub: 'Pila, Laguna — heritage town — 17 barangays', category: 'City Center',
      latlng: { lat: 14.233958, lng: 121.364398 }, hazards: [] },
    { name: 'Rizal Municipal Hall', sub: 'Rizal, Laguna — 11 barangays', category: 'City Center',
      latlng: { lat: 14.1083, lng: 121.3917 }, hazards: [] },
    { name: 'Santa Maria Municipal Hall', sub: 'Santa Maria, Laguna — 25 barangays', category: 'City Center',
      latlng: { lat: 14.475, lng: 121.425 }, hazards: [] },
    { name: 'Siniloan Municipal Hall', sub: 'Siniloan, Laguna — "A Waterfall Sanctuary" — 20 barangays', category: 'City Center',
      latlng: { lat: 14.421999, lng: 121.446129 }, hazards: [] },
    { name: 'Victoria Municipal Hall', sub: 'Victoria, Laguna — Duck Raising Capital of the Philippines — 9 barangays', category: 'City Center',
  ...
  async function loadLivePois(){
    ...
    BiyaStorage.save(BiyaStorage.keys.poisCache, livePois);
    recomputePoiEntries();
  }
  ...
  destInput.addEventListener('input', ()=>{
    ...
    renderSuggestions(q ? livePois.filter(d => d.name.toLowerCase().includes(q)) : livePois);
  });
