...
(function(){
  ...
  // rather than accidentally admin.
...
showToast(
  ...
  // Reports/POIs tab switch, scoped to the admin dashboard specifically
  // (its own data-admintab attribute, separate from the report sheet's
  // own .sheet-tab usage elsewhere in this file).
...
.forEach(btn => {
  ...
  const lagunaDestinations = [
    ...
    { name: 'San Pedro City Hall', sub: 'San Pedro City, Laguna', category: 'City Center',
